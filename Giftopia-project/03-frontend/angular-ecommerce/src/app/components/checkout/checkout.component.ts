...
export class CheckoutComponent implements OnInit {
  ...
  ngOnInit(): void {
      ...
      customer: this.formBuilder.group({
        firstName: new FormControl('',
                              [Validators.required,
                               ...
                               GiftopiaValidators.notOnlyWhitespace]),
    ...
    this.giftopiaFormService.getCountries().subscribe(
      data => {
  ...
  onSubmit() {
    ...
    */
    ...
    //call REST AIT via the CheckoutService
  ...
  getStates(formGroupName: string) {
    ...
    this.giftopiaFormService.getStates(countryCode).subscribe(
      data => {
